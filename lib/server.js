...
let productsArrayrDB = [
    {
        ...
        "description": "a category for electronics products11"
    }
];
/**************************************************************************/
...
/**************************************************************************/
app.put('/api/v1/categories/:id', timestampHandler, (req, res) => {
    let id = req.params.id;
    let record = {
        id: req.body.id,
        category: req.body.category,
...
/**************************************************************************/
app.delete('/api/v1/categories/:id', timestampHandler, (req, res) => {
    let id = req.params.id;
    categoriesArrayrDB.splice(id, 1);
    res.status(200).send('deleted :)');
});
